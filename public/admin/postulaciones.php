    ...
    <div class="container-xxl px-4 py-4" id ="contenido-dinamico">
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalVerPostulacionLabel">Detalle de la Postulación</h5>
        ...
        <script>
            ...
            function verPostulacion(id) {
                alert(`Abrir modal de postulacion con ID ${id}`);
            ...
            function verPostulacion(id) {
                ...
                $.get('postulacionModal.php', {
                    ...
                    $('#contenidoModalPostulacion').html('<p class="text-danger">Error al cargar la postulacion.</p>');
                });
            }
